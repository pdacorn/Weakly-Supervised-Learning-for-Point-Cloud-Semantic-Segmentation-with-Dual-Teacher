...
def build_dataloader(cfg, split):
    ...
    if 's3dis' in cfg.dataset.common.NAME.lower():
        ...
        dataset = scannet_dataset(cfg, dataset_cfg.common, split_cfg)
    elif 'semantic3d' in cfg.dataset.common.NAME.lower():
        dataset = semantic3d_dataset(cfg, dataset_cfg.common, split_cfg)
